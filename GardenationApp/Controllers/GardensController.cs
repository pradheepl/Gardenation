...
namespace GardenationApp.Controllers
{
    public class GardensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GardenID,Name,CreatedDate,LastVisitedDate,SpringFrostDate,FallFrostDate,Height,Length,SqFeet,CityID")] Garden garden)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GardenID,Name,CreatedDate,LastVisitedDate,SpringFrostDate,FallFrostDate,Height,Length,SqFeet,CityID")] Garden garden)
        {
            if (ModelState.IsValid)
            {
